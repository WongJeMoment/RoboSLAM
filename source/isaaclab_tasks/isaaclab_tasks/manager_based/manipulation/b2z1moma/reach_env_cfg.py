...
class ReachSceneCfg(InteractiveSceneCfg):
    ...
    obstacle1 = AssetBaseCfg(
        ...
        init_state=AssetBaseCfg.InitialStateCfg(pos=[1.0, 0.8, 0]),
    ...
    #scene_entities = {"robot": robot, "ray_caster": ray_caster}
##
# MDP settings
##
...
class EventCfg:
    ...
    reset_object_position = EventTerm(
        ...
        mode="reset",
        params={
            "pose_range": {"x": (0.0, 0.2), "y": (0.0, 0.0), "z": (-0.3, -0.2)},
            "velocity_range": {},
    ...
    reset_robot_position = EventTerm(
        ...
        mode="reset",
        params={
            "pose_range": {"x": (0.0, 0.1), "y": (-0.3, 0.3), "z": (-0.1, -0.1)},
            "velocity_range": {},
...
class CurriculumCfg:
    ...
    joint_vel = CurrTerm(
        func=mdp.modify_reward_weight, params={"term_name": "joint_vel", "weight": -0.0002, "num_steps": 20000}
    )
